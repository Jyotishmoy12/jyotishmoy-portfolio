...
This section showcases my projects built with Python, ranging from backend services and automation bots to data science and research tools.
...
A squad of specialized AI agents that collaboratively audit GitHub Pull Requests for security vulnerabilities, documentation quality, and code health.

[Read Case Study](observer.md){ .md-button }
